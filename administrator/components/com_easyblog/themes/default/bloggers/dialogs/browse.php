...
<<<<<<< HEAD
	...
	<content type="text"><?php echo JURI::root();?>administrator/index.php?option=com_easyblog&view=bloggers&tmpl=component&browse=1&browsefunction=insertMember</content>
	<buttons>
