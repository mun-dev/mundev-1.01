...
>>>>>>> master
		...
		if (isset($data['main_description'])) {
			$data['main_description']	= $this->input->get( 'main_description', '', 'post', 'string', JREQUEST_ALLOWRAW);
		}

		// Updated addthis custom code to allow html codes
		if (isset($data['social_addthis_customcode'])) {
			$data['social_addthis_customcode']	= $this->input->get( 'social_addthis_customcode', '', 'post', 'string', JREQUEST_ALLOWRAW);
		}
