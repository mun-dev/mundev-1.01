...
<div class="es-container" data-es-container data-blog>
	...
	<?php if ($this->isMobile()) { ?>
		<?php echo $this->output('apps/user/blog/profile/mobile.filters'); ?>
	<?php } ?>
			...
			<div data-blog-lists>
				<?php if ($posts) { ?>
					<?php foreach ($posts as $post) { ?>
						<?php echo $this->loadTemplate('themes:/apps/user/blog/profile/item', array('post' => $post, 'user' => $user, 'return' => $return, 'userAcl' => $userAcl)); ?>
					<?php } ?>
				<?php } ?>
			</div>
				...
				<div class="o-empty">
					<div class="o-empty__content">
						...
						<div class="o-empty__action">
							<a class="btn btn-es-primary btn-sm " href="<?php echo EB::composer()->getComposeUrl(array('return' => $return));?>" data-eb-composer>
								<?php echo JText::_('APP_USER_BLOG_NEW_POST_BUTTON'); ?>
							</a>
						</div>
						<?php } ?>
					</div>
