...
}),b.resolve()}),EasyBlog.module("composer/blocks",function(a){var b=this,c="is-new",d="is-editable",e="is-receiving",f="is-dropping",g="is-releasing",h="is-refocusing",i="is-highlighting",j="is-sorting",k="is-sort-item",l="is-nested",m="is-dragging-block",n="is-dropping-block",o="is-inserting-block",p="is-selected",q="is-highlighting-block";EasyBlog.require().library("ui/draggable","ui/position","image","scrollTo").script("composer/blocks/panel","composer/blocks/guide","composer/blocks/nestable","composer/blocks/droppable","composer/blocks/resizable","composer/blocks/scrollable","composer/blocks/font","composer/blocks/dimensions","composer/blocks/text","composer/blocks/removal","composer/blocks/tree","composer/blocks/search","composer/blocks/mobile","composer/blocks/toolbar").done(function(){EasyBlog.Controller("Composer.Blocks",{hostname:"blocks",pluginExtendsInstance:!0,elements:["[data-eb-composer-{blocks}]","[data-eb-composer-block-{menu|menu-group|meta}]","[data-eb-composer-{editor}]","[data-ebd-block-{viewport|content}]"],defaultOptions:a.extend({"{view}":"[data-eb-composer-blocks]","{editableContent}":EBD.editableContent,"{immediateBlockViewport}":EBD.immediateBlockViewport,"{immediateBlockContent}":EBD.immediateBlockContent,"{blockActions}":EBD.blockActions,"{sidebar}":"[data-eb-composer-blocks]","{mechswitch}":".mechswitch","{blockSection}":"[data-eb-composer-block-section]","{blockSectionHeader}":"[data-eb-composer-block-section-header]","{blockSectionHeaderIcon}":"[data-eb-composer-block-section-header] > [data-panel-icon]","{blockSectionContent}":"[data-eb-composer-block-section-content]","{searchInput}":"[data-eb-blocks-search]"},EBD.selectors)},function(b,r,s,t){return{init:function(){t=b.composer;
...
},"{self} composerBlockMenuSelected":function(a,c,d){b.selectedBlock=d},"{self} composerBlockInit":function(c,d,e){var f=g.getBlockType(e);if("image"==f){var h=a.extend(!0,{},b.draggableOptions,{cursorAt:{top:0,left:0}});return e.draggable(h),void 0}e.draggable(b.draggableOptions)},populateDropzones:function(){var c=f.viewportContent().scrollTop(),d=f.viewportContent()[0].scrollHeight;b.nest().each(function(){var c=a(this),d=c.data("type");if("block"==d&&(c.prepend(b.createNestedDropzone()),c.find(EBD.childBlock).each(function(){var c=a(this);
c.after(b.createNestedDropzone())})),"content"==d){var e=g.nestable.availablePositions(c);a.each(e,function(a,d){c.prepend(b.createNestedDropzone(d))})}});var e=g.getRootBlocks();if(e.each(function(c){var d=a(this);0==c&&d.before(b.createDropzone()),d.hasClass("is-sort-item")||d.after(b.createDropzone())}),e.length<1&&b.root().append(b.createDropzone()),b.dropzone().droppable(b.droppableOptions),a.browser.safari){var h=f.viewportContent()[0].scrollHeight,i=(h-d)/d*100,j=c+c*i/100;f.viewportContent().scrollTop(j)
}},createDropzone:function(){return a(b.dropzonePlaceholder).clone()},createNestedDropzone:function(a){var c=b.createDropzone().addClass("is-nested");return a&&c.addClass("nest-"+a).data("position",a),c},destroyDropzones:function(){var c=f.viewportContent().scrollTop(),d=f.viewportContent()[0].scrollHeight;if(b.dropzone().remove(),a.browser.safari){var e=f.viewportContent()[0].scrollHeight,g=(e-d)/d*100,h=c+c*g/100;f.viewportContent().scrollTop(h)}},"{block} dragstart":function(a,c,d){c.stopPropagation(),d.helper.addClass("is-helper").css({width:a.width(),height:a.height()}),g.drag(a),h=a,b.populateDropzones(),f.manager().addClass("is-resizing")
...
return b.textWrapper.inside(d).removeAttr("contenteditable").editable(!1),a},refocus:function(){},reset:function(){},populate:function(a){var c=f.data(a);b.buttonSwatchItem().removeClass("active").where("style",c.style).addClass("active");var d=b.buttonSize().filter('[data-size="'+c.size+'"]');d.siblings().removeClass("active"),d.addClass("active"),b.buttonHyperlink().val(c.link),b.buttonNofollow().val(c.nofollow).trigger("change"),b.buttonTarget().val(c.target)},"{buttonSwatchItem} click":function(a){var d=a.data("style"),e=f.getBlockContent(h);
b.buttonSwatchItem().removeClass("active").where("style",d).addClass("active"),b.button.inside(e).removeClass(c.buttonClasses).addClass(d),f.data(h).style=d},"{buttonSwatchItem} mouseover":function(a){clearTimeout(b.previewTimer);var d=a.data("style"),e=f.getBlockContent(h);b.button.inside(e).removeClass(c.buttonClasses).addClass(d)},"{buttonSwatchItem} mouseout":function(){clearTimeout(b.previewTimer);var d=f.getBlockContent(h);b.previewTimer=setTimeout(function(){b.button.inside(d).removeClass(c.buttonClasses).addClass(f.data(h).style)
},50)},"{buttonSize} click":function(a){var c=a.data("size"),d=f.getBlockContent(h);a.addClass("active").siblings().removeClass("active"),b.button.inside(d).removeClass("btn-sm btn-xs btn-lg btn-xlg").addClass(c),f.data(h).size=c},"{buttonSize} mouseover":function(a){clearTimeout(b.previewTimer);var c=a.data("size"),d=f.getBlockContent(h);b.button.inside(d).removeClass("btn-sm btn-xs btn-lg btn-xlg").addClass(c)},"{buttonSize} mouseout":function(){clearTimeout(b.previewTimer);var c=f.getBlockContent(h);b.previewTimer=setTimeout(function(){b.button.inside(c).removeClass("btn-sm btn-xs btn-lg btn-xlg").addClass(f.data(h).size)
},50)},"{buttonHyperlink} keyup":a.debounce(function(a){var c=f.getBlockContent(h),d=f.data(h);d.link=a.val(),b.button.inside(c).attr("href",a.val())},250),"{buttonNofollow} change":function(a){var c=f.getBlockContent(h),d=f.data(h);d.nofollow=1==a.val()?1:0,b.button.inside(c).attr("rel",1==a.val()?"nofollow":"")},"{buttonTarget} change":function(a){var c=f.getBlockContent(h),d=f.data(h);d.target=a.val(),b.button.inside(c).attr("target",a.val())}}}),b.resolve()}),EasyBlog.module("composer/blocks/handlers/code",function(a){var b=this,c=a.rootPath+"/media/com_easyblog/scripts/vendors/ace.js";
window.FD50_PSEUDO={module:function(b,c){c.call(a.Deferred(),a)}},EasyBlog.Controller("Composer.Blocks.Handlers.Code",{defaultOptions:{"{pre}":"> pre","{readOnly}":"[data-code-readonly]","{showGutter}":"[data-code-gutter]","{fontsize}":"[data-code-fontsize]","{themeSelection}":"[data-code-theme]","{modeSelection}":"[data-code-mode]","{iframeHeight}":"[data-code-height]",theme:"github",mode:"javascript",css:{position:"fixed",width:"100%",height:"100%",top:0,bottom:0,left:0,right:0,margin:0,padding:0}}},function(b,d,e,f,g,h,i){return{init:function(){g=b.blocks,f=g.composer,h=d.meta,i=a()
...
},reconstruct:function(){},deconstruct:function(a,c){return c&&(a=a.clone()),b.headingElement.inside(a).editable(!1),a},refocus:function(a){var c=b.headingElement.inside(a);c.focus(),a.hasClass("is-new")&&e.editor.caret.setEnd(c[0])},reset:function(a){a.html(g.content)},populate:function(a){var c=b.level(a);b.levelSelection().where("level",c).activateClass("active")},toggleFontSizeMenu:function(b){var c=a("[data-eb-font-size-menu]");1==b?c.show():c.hide()},toData:function(a){return f.getData(a)},toHTML:function(a){var a=f.getBlockContent(a);
return b.deconstruct(a,!0).html()},toText:function(a){return a.text()},heading:{inside:function(a){return a.children(":first")}},level:function(a,c){var d=f.getBlockContent(a),e=b.headingElement.inside(d),g=e.tagName();return c&&g!==c&&(d.html(b.construct({level:c,content:e.html()})),b.headingElement.inside(a).editable(!0),g=c),g},getContent:function(a){var c=f.getBlockContent(a),d=b.headingElement.inside(c),e=d.find("> span").text();return"\xa0"==e&&(e=d.text()),e},updateFontFamily:function(a,c){var d=f.getBlockContent(a),e=b.headingElement.inside(d);
e.css("fontFamily",c)},setLevel:function(a,c){var c=b.level(a,c),d=b.headingElement.inside(a),e=[a,b,d];b.trigger("composerBlockHeadingSetLevel",e),b.trigger("composerBlockChange",e)},previewLevel:function(a,c){clearTimeout(b.previewTimer);var d=b.headingElement.inside(a),e=d.tagName();a.defineData("originalLevel",e).addClass("is-preview"),b.level(a,c);var f=[a,b,d];b.trigger("composerBlockHeadingPreviewLevel",f),b.trigger("composerBlockChange",f)},previewTimer:null,"{levelSelection} mouseover":function(a){a.data("level")
},"{levelSelection} mouseout":function(){clearTimeout(b.previewTimer),b.previewTimer=setTimeout(function(){var a=h.data("originalLevel");a&&b.setLevel(h,a)},50)},"{levelSelection} click":function(a){var c=a.data("level");b.setLevel(h,c),b.refocus(h)},"{self} composerBlockFontFamilyUnpreview":function(a,c,d,e){var f=h.data("uid"),g=e.data("uid");f==g&&b.updateFontFamily(h,d)},"{self} composerBlockFontFamilyPreview":function(a,c,d,e,f){var g=h.data("uid"),i=f.data("uid");g==i&&b.updateFontFamily(h,d)},"{self} composerBlockFontFamilyChange":function(a,c,d,e){var f=h.data("uid"),g=e.data("uid");
f==g&&b.updateFontFamily(h,d)},"{self} composerBlockHeadingSetLevel":function(a,c,d){clearTimeout(b.previewTimer),d.removeClass("is-preview").removeData("originalLevel"),d.is(h)&&b.populate(d)},"{self} composerBlockDuplicate":function(a,b,c,d){var e=f.getBlockType(c);if("heading"==e){var g=d.attr("style");g&&c.attr("style",g)}}}}),b.resolve()}),EasyBlog.module("composer/blocks/handlers/html",function(){var b=this;EasyBlog.require().library("ace").done(function(a){EasyBlog.Controller("Composer.Blocks.Handlers.Html",{defaultOptions:{"{pre}":"[data-eb-composer-blocks-html-pre]"}},function(b,c,d,e,f,g,h){return{init:function(){f=b.blocks,e=f.composer,g=c.meta,h=a(),syncing=!1,sessionSync=!1
...
}).fail(function(a){b.showForm(c),b.errorMessage().html(a).removeClass("hide")})},showForm:function(a){var c=f.getBlockContent(a);b.form.inside(c).removeClass("hidden"),b.loader.inside(c).addClass("hidden")},hideForm:function(a){var c=f.getBlockContent(a);b.form.inside(c).addClass("hidden"),b.loader.inside(c).removeClass("hidden")},"{fsUpdate} click":function(){var c=(f.getBlockContent(h),b.fsSource().val());b.insertEmbed(h,c)}}}),b.resolve()}),EasyBlog.module("composer/blocks/handlers/post",function(a){var b=this;
...
c.source&&!d?b.setOverlay(a):0==c.source.length&&c.url?(e.html(g.html),b.crawl(c.url,a)):e.html(g.html),a.find(b.source.selector).off("paste").on("paste",function(a){a.stopPropagation()})},deconstruct:function(){},refocus:function(){},reset:function(){},populate:function(a){f.data(a);b.updateFieldset(a)},updateFieldset:function(a){var c=f.data(a);b.url().val(c.url),b.width().val(c.width),b.height().val(c.height),b.fluid().val(c.fluid?"1":"0").trigger("change"),b.related().val(c.related?"any":"same").trigger("change"),b.nocookie().val(c.nocookie?"1":"0").trigger("change")
},getOverlay:function(a){var c=a.data("overlay"),g=(f.data(a),f.getBlockContent(a));if(!c){c=e.document.overlay.create(a);var h=b.getWrapper();c.placeholder().appendTo(h),g.empty().append(h),c.attach()}return c},setWrapperLayout:function(a){var c=b.wrapper.inside(a),d=f.data(a);d.fluid?c.addClass("is-responsive").css({width:"",height:""}):(c.hasClass("is-responsive")&&(d.width=c.width(),d.height=c.outerHeight()),b.width().val(d.width),b.height().val(d.height),c.css({width:d.width,height:d.height}).removeClass("is-responsive"))
...
g.css("height",e);var i=b.getOverlay(h);i.refresh()}},250),"{updateUrl} click":function(){var d=b.url().val(),g=(f.data(h),f.getBlockContent(h));return b.isUrlValid(d)?(b.crawl(d,h),void 0):(b.errorMessage.inside(g).removeClass("hide"),void 0)},"{nocookie} change":function(a){var d=f.data(h);if(d.url){var e=1==a.val()?!0:!1;d.embed=e?d.embed_nocookie:d.embed_original,d.related||(d.embed=d.embed.replace("?feature=oembed","?feature=oembed&rel=0")),d.nocookie=e,b.setOverlay(h)}}}}),b.resolve()}),EasyBlog.module("composer/blocks/mobile",function(a){var b=this;
...
try{var h=a("<iframe>");h.on("load",function(){a(h[0].contentWindow.document.body).css({margin:0,overflow:"hidden"}).append(d).append(e)}),f.append(h)}catch(i){console.error("There may a cross-iframe security issue. Unable to create text link item properly",i)}},updateLinkItem:function(c,d){b.linkPreviewCaption.inside(c).html(a(d).text()),a(c.data("linkUrlField")).val(d.getAttribute("href")),a(c.data("linkTitleField")).val(d.title),b.linkBlankOption.inside(c).prop("checked","_blank"==d.target),b.linkNofollowOption.inside(c).prop("checked",d.rel.toLowerCase().indexOf("nofollow")>=0),c.data("anchorNode",d)
...
},updateAnchorNode:function(c){var d=c.data("anchorNode");if(d){var e=a(c.data("linkUrlField")),f=a(c.data("linkTitleField")),g=b.linkBlankOption.inside(c),h=b.linkNofollowOption.inside(c);if(d.href=a.trim(e.val()),d.title=f.val(),g.is(":checked")||h.is(":checked")){var i="";g.is(":checked")&&(d.target="_blank",i+="noopener noreferrer"),h.is(":checked")&&(i+=" nofollow"),i=a.trim(i),d.rel=i}else d.removeAttribute("target"),d.removeAttribute("rel")}},removeAnchorNode:function(b){var c=b.data("anchorNode");c&&(g.selection.save(),$anchorNode=a(c),$anchorNode.contents().insertAfter($anchorNode),$anchorNode.remove(),g.selection.restore(),b.removeData("anchorNode"))
...
d&&a(d).addClass("is-highlighting")},"{linkItem} mouseout":function(b){var d=b.data("anchorNode");d&&a(d).removeClass("is-highlighting")},linkUrlFieldInputHandler:function(){var d=a(this);b.startEditingSelection();var e=a(d.data("linkItem")),f=a.trim(d.val()),h=e.data("anchorNode");return""===f||h||(a.IE&&g.selection.restore(),h=b.createAnchorNode(e),d.focus().val(d.val())),""==f&&h?(b.removeAnchorNode(e),void 0):(b.updateAnchorNode(e),void 0)},linkTitleFieldInputHandler:function(){var d=a(this);b.startEditingSelection();
...
EasyBlog.Controller("Composer.Blocks.Toolbar",{elements:["[data-eb-blocks-{close-button|parent-button|cancel-move-button}]","[data-ebd-block-{toolbar|sort-handle}]"],defaultOptions:a.extend({"{cancelDropButton}":"[data-blocks-cancel-drop-button]","{cancelMoveButton}":"[data-blocks-cancel-move]","{closeBlocks}":"[data-toolbar-blocks-close]","{toolbarWrapper}":"[data-toolbar-blocks-wrapper]","{done}":"[data-blocks-done]","{insert}":"[data-blocks-insert]","{move}":"[data-blocks-move]","{duplicate}":"[data-blocks-duplicate]","{remove}":"[data-blocks-remove]"},EBD.selectors)},function(a,b,h,i,j){return{init:function(){j=a.blocks,i=a.blocks.composer
},dropping:!1,cancelDrop:function(){i.blocks.droppable.selectedMenu=null,i.blocks.droppable.selectedBlock=null,i.blocks.droppable.dropStop(),i.blocks.menu().removeClass(g),i.manager().removeClass(e)},"{closeBlocks} click":function(){a.cancelDrop(),i.manager().removeClass(f),i.blocks.browser.close()},"{self} composerBlockDrop":function(){a.dropping=!1},"{self} composerBlockMenuSelected":function(){a.dropping=!0},"{self} click":function(){},"{self} composerBlockActivate":function(b,d,e){if(!e.hasClass("is-standalone")){i.manager().addClass(c);
var f=j.isNestedBlock(e);blockActions=j.getBlockActions(e),f&&(blockActions.find(a.duplicate().selector).remove(),blockActions.find(a.insert().selector).remove()),e.hasClass("is-isolated")&&blockActions.find(a.move().selector).remove()}},"{self} composerBlockDeactivate":function(){i.manager().removeClass(c).removeClass(f)},"{cancelMoveButton} click":function(){i.manager().removeClass(d),i.blocks.droppable.dropStop();var c=j.getCurrentBlock();c.removeClass("hide").removeClass("is-sort-item"),a.workarea().removeClass("is-sorting")
},"{parentButton} click":function(){var b=j.getCurrentBlock();if(b.length){var c=j.getParentBlock(b);c.length?j.activateBlock(c):j.deactivateBlock()}},"{cancelDropButton} click":function(){a.cancelDrop()},"{closeButton} click":function(){i.views.hide("blocks")},"{duplicate} click":function(b,c){c.stopPropagation();var d=j.getCurrentBlock(),e=j.getBlockContent(d),f=j.getBlockType(d),g=j.getData(d),h=j.createBlock(f);j.data(h,g),j.setBlockContent(h,e),d.after(h),j.drop(h),j.release(h),j.out(h),a.trigger("composerBlockDuplicate",[h,d])
},"{move} click":function(){var e=i.manager().hasClass(d);if(!e){i.blocks.droppable.populateDropzones(),i.manager().addClass(d);var f=j.getCurrentBlock();f.addClass("is-sort-item"),a.workarea().addClass("is-sorting"),a.trigger("composerBlockMove",[f])}},"{remove} click":function(){var c=j.getCurrentBlock();j.removeBlock(c),i.manager().removeClass("is-editing-block").removeClass("is-inserting-block")},"{insert} click":function(){i.manager().toggleClass("is-inserting-block"),i.blocks.browser.toggle()}}}),b.resolve()
}),EasyBlog.module("composer/blocks/tree",function(a){var b=this;EasyBlog.Controller("Composer.Blocks.Tree",{elements:["[data-eb-{block|block-icon|block-title|block-level-count|block-child-count}]","[data-eb-blocks-{tree-field|tree|tree-item|tree-item-template|tree-item-icon|tree-item-title|tree-item-group|tree-toggle-button}]"]},function(b,c,d,e,f,g){return{init:function(){f=b.blocks,e=f.composer,g=b.createTreeItem,b.treeItemTemplate=b.treeItemTemplate().detach().html()},setCurrentBlock:function(a){var c=f.getBlockType(a),d=f.getBlockMeta(c);
b.blockTitle().text(d.title),b.blockIcon().attr("class",d.icon);var e=f.getAllParentBlocks(a),g=f.getChildBlocks(a),h=g.length,i=e.length+1;b.blockChildCount().text(h),b.blockLevelCount().text(i),b.block().toggleClass("has-child",h)},populate:function(c){if(!c)var c=f.getCurrentBlock();if(c.length){var d=b.treeField(),e=f.getParentBlock(c),h=!!e.length,i=f.getChildBlocks(c),j=!!i.length;d.toggleClass("has-parent",h).toggleClass("has-children",j);var k=[],l=b.getTreeDisplayMode();if("minimal"==l)if(h){k.push(g(e,1));
var m=f.getChildBlocks(e);m.each(function(){var b=a(this);k.push(g(b,2)),b.is(c)&&i.each(function(){var b=a(this);k.push(g(b,3))})})}else k.push(g(c,1)),i.each(function(){var b=a(this);k.push(g(b,2))});else{var n=f.getRootBlocks(),o=function(b,c){var d=c;k.push(g(b,d));var e=f.getChildBlocks(b);e.each(function(){var b=a(this);o(b,d+1)})};n.each(function(){o(a(this),1)})}b.tree().toggle("full"==l||k.length>1),b.treeItemGroup().empty().append(k)}},createTreeItem:function(a,c){var d=a.data("treeItem");return d||(d=b.renderTreeItem(a),a.data("treeItem",d)),d.toggleClass("active",a.hasClass("active")).toggleClass("is-nested",a.hasClass("is-nested")).switchClass("level-"+c),d
},renderTreeItem:function(c){var d=f.getBlockUid(c),e=f.getBlockType(c),g=f.getBlockMeta(e),h=a(b.treeItemTemplate);return h.attr({"data-type":g.type,"data-uid":d}).find(b.treeItemIcon).addClass(g.icon).end().find(b.treeItemTitle).text(g.title),h},getTreeDisplayMode:function(){return b.treeField().hasClass("tree-minimal")?"minimal":"full"},setTreeDisplayMode:function(a){b.treeField().switchClass("tree-"+a),b.populate()},"{self} composerBlockAdd":function(){b.populate()},"{self} composerBlockActivate":function(a,c,d){b.setCurrentBlock(d),b.populate(d)
},"{self} composerBlockRemove":function(){b.populate()},"{treeItem} click":function(a){var b=a.data("uid"),c=f.getBlock(b);f.unhighlight(c),f.activateBlock(c)},"{treeItem} mouseenter":function(a){var b=a.data("uid"),c=f.getBlock(b);f.highlight(c),f.scrollTo(c)},"{treeItem} mouseleave":function(a){var b=a.data("uid"),c=f.getBlock(b);f.unhighlight(c)},"{treeToggleButton} click":function(){var c=(b.treeField(),b.getTreeDisplayMode());b.setTreeDisplayMode("minimal"==c?"full":"minimal")}}}),b.resolve()}),EasyBlog.module("composer/category",function(a){var b=this;
...
})}},trash:function(){b.disableLeavePrompt(),EasyBlog.dialog({content:EasyBlog.ajax("site/views/composer/confirmTrash"),bindings:{"{deleteButton} click":function(){EasyBlog.ajax("site/views/composer/delete",{uid:b.getPostUid()}).done(function(){})}}})},setMessage:function(d){a.isArray(d)||(d=[d]);var e=d[0],f="success";/error|danger/.test(e.type)&&(f="danger"),b.alert().length<=0&&a(c.templates.alert).appendTo(b.alertPlaceholder()),b.alert().removeClass("t-hidden"),b.alert().removeClass("o-alert--success o-alert--danger").addClass("o-alert--"+f),b.alert().find(b.alertMessage).html(e.message)
...
b.setLocation(c)},"{remove} click":function(){b.removeLocation()},"{container} click":function(a,b){b.stopPropagation()}}}),b.resolve()}),EasyBlog.module("composer/document/osm",function(){var b=this;EasyBlog.require().library("leaflet","leaflet-providers").done(function(a){EasyBlog.Controller("Composer.Document.Osm",{elements:["[data-eb-composer-location-{places|autocomplete|form|form-message}]"],defaultOptions:{"{container}":"[data-location-container]",geomode:"native",searchmode:"detect","{detect}":"[data-location-detect]","{remove}":"[data-location-remove]","{preview}":"[data-location-preview]","{map}":"[data-location-map]","{inputContainer}":"[data-location-input-container]","{input}":"[data-location-input]","{address}":"[data-location-address]","{latitude}":"[data-location-latitude]","{longitude}":"[data-location-longitude]","{place}":"[data-eb-composer-location-places] li"}},function(b,c,d,e,f,g){return{init:function(){b.composer=g=b.document.composer,d=b.container(),c.apikey=b.container().data("google-apikey"),navigator.geolocation||(c.geomode="external"),b.setupAutocomplete()
},initMap:function(){b.osm=L.map("map",{zoom:12}),b.osm.fitWorld(),L.tileLayer.provider("Wikimedia").addTo(b.osm),b.preview().addClass("has-location")},setupAutocomplete:function(){e=b.autocomplete().detach(),f=e.find(b.places),textfield=b.input(),a(document).on("click",function(b){var c=a(b.target).parents().andSelf();c.filter(textfield).length<1&&e.detach()})},searching:function(a){b.container().toggleClass("is-searching",a);var c=b.input();c.attr("placeholder",a?c.data("placeholder-searching"):c.data("placeholder"))
},userCoords:null,getUserCoords:function(){var d=a.Deferred(),e=b.userCoords;return e?(d.resolve(e),d):("native"==c.geomode?navigator.geolocation.getCurrentPosition(function(a){var b=a.coords;d.resolve({latitude:b.latitude,longitude:b.longitude})},function(){b.getUserCoordsByIP().done(d.resolve).fail(d.reject)}):d=b.getUserCoordsByIP(),d.done(function(a){b.userCoords=a}))},getUserCoordsByIP:function(){a.getJSON("//www.telize.com/geoip?callback=?").then(function(a){return{latitude:a.latitude,longitude:a.longitude}
})},search:function(a){var c=b.getUserCoords().then(function(c){b.searching(!0);var d=EasyBlog.ajax("site/views/composer/getLocations",{latitude:c.latitude,longitude:c.longitude,query:a||""});return d}).fail(function(c){b.container().addClass("has-errors"),b.formMessage().html(c),b.search.reset(a)}).always(function(){b.searching(!1)});return c},navigate:function(a,c){var d={lat:parseFloat(a),lng:parseFloat(c)};void 0!==b.marker&&b.osm.removeLayer(b.marker),b.osm.flyTo(d,10,{duration:3}),b.marker=L.marker(d).addTo(b.osm)
},"{self} composerViewShow":function(a,c,d){"location"==d&&void 0===b.osm&&(b.preview().addClass("has-location"),setTimeout(function(){b.initMap(),latitude=b.latitude().val(),longitude=b.longitude().val(),latitude&&longitude&&b.navigate(latitude,longitude)},250))},"{self} mobileLocationShow":function(){b.preview().addClass("has-location"),setTimeout(function(){b.initMap(),latitude=b.latitude().val(),longitude=b.longitude().val(),latitude&&longitude&&b.navigate(latitude,longitude)},250)},searchManual:a.memoize(function(c){var d=a.Deferred();
b.searching(!0);var e=EasyBlog.ajax("site/views/composer/getLocations",{query:c}).done(function(){d.resolve()}).always(function(){b.searching(!1)});return e}),populate:function(){var c=b.input(),d=a.trim(c.val()),e=b.searchmode;if("detect"==e)b.search(d).done(a.debounce(function(c){var d=[];a.each(c,function(b,c){var e=a.create("li").html("<strong>"+c.name+"</strong><small></small>").data("venue",c)[0];d.push(e)}),f.empty().append(d),b.reposition()},50)).fail(function(){});else{if(""==d)return;b.searchManual(d).done(a.debounce(function(c){var d=[];
a.each(c,function(b,c){var e=a.create("li").html("<strong>"+c.name+"</strong><small></small>").data("venue",c)[0];d.push(e)}),f.empty().append(d),b.reposition()},100)).fail(function(){})}},_populate:a.debounce(function(){b.populate()},350),reposition:function(){var a=b.input();e.appendTo(b.inputContainer()).css({width:a.outerWidth()}).position({my:"left top",at:"left bottom",of:a})},currentLocation:null,setLocation:function(a){b.currentLocation=a,e.detach(),b.input().val(a.name),b.latitude().val(a.latitude),b.longitude().val(a.longitude),b.navigate(a.latitude,a.longitude)
...
},activate:function(){},deactivate:function(){},isActive:function(){},hideBlocks:function(){b.blocks().parent().removeClass("open")},"{toggleSidebar} click":function(){e.manager().toggleClass("is-sidebar-open")},"{media} click":function(a){b.hideBlocks(),EasyBlog.MediaManager.open(a.data("uri"))},"{closeDropdown} click":function(a,c){c.stopPropagation();var d=a.parents(b.button.selector),f=d.data("type");d.removeClass("open"),e.views.hide(f)},"{blocks} click":function(){e.blocks.browser.toggle()},"{button} click":function(a){b.hideBlocks(),b.deactivate();
var d=a.data("type");e.views.show(d)},"{embedVideo} click":function(){EasyBlog.dialog({content:EasyBlog.ajax("site/views/composer/embedVideoDialog"),bindings:{"{insertButton} click":function(){var a=this.videoUrl().val();if(a){var b=this.videoWidth().val(),c=this.videoHeight().val(),d=this.noCookie().val(),e=this.relatedSource().val();"same"==e&&(a+="&rel=0");var f='[embed=videolink]{"video":"'+a+'","width":"'+b+'","height":"'+c+'","nocookie":"'+d+'"}[/embed]';EasyBlog.LegacyEditor.insert(f),EasyBlog.dialog().close(),this.videoUrl().val("")
...
},"{closeTemplateSelector} click":function(){var c=a.selectTemplate("[data-blank=1]"),d=c.data("uid");a.trigger("composerSelectTemplate",[d])},"{selectTemplate} click":function(b){var c=b.data("uid"),e=b.data("blank");return e?(a.trigger("composerSelectTemplate",[c]),void 0):(EasyBlog.ajax("site/views/composer/renderTemplate",{uid:c}).done(function(b,e,f){f&&(d.document.isLegacy()?d.document.insertContent(f):d.document.loadDocument(f)),a.trigger("composerSelectTemplate",[c,b,e,f])}),void 0)},"{deleteTemplate} click":function(b,c){c.stopPropagation();
var d=b.parents(a.selectTemplate.selector),e=d.data("uid");EasyBlog.dialog({content:EasyBlog.ajax("site/views/templates/confirmDelete",{id:e,deleteAction:"ajax"}),bindings:{"{submitButton} click":function(){EasyBlog.ajax("site/controllers/templates/delete",{ids:[e]}).done(function(){EasyBlog.dialog().close(),d.remove()})}}})}}}),b.resolve()}),EasyBlog.module("composer/vendors/colorpicker",function(a){var b=".colorpicker-hsb-panel",c=".colorpicker-h-panel",d=".colorpicker-sb-panel",e=".colorpicker-h-handle",f=".colorpicker-sb-handle",g=".colorpicker-preview",h=".colorpicker-hex-input",i={color:"#000000",document:document};
