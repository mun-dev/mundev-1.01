!function(){var a=function(a){var b=this,c=function(){!function(b,c){"use strict";function e(a,b){for(var c,e=[],f=0;f<a.length;++f){if(c=d[a[f]]||h(a[f]),!c)throw"module definition dependecy not found: "+a[f];e.push(c)}b.apply(null,e)}function f(a,b,f){if("string"!=typeof a)throw"invalid module definition, module id must be defined and be a string";if(b===c)throw"invalid module definition, dependencies must be specified";if(f===c)throw"invalid module definition, definition function must be specified";e(b,function(){d[a]=f.apply(null,arguments)
...
<<<<<<< HEAD
"array"!==b.typeOf(a)&&(a=[a]);for(var d=0;d<a.length;d++)c="on"+a[d],"function"===b.typeOf(this[c])?this.addEventListener(a[d],this[c]):"undefined"===b.typeOf(this[c])&&(this[c]=null)}})}return c.instance=new c,c}),f("moxie/core/utils/Encode",[],function(){var a={_keyStr:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",encode:function(b){var d,e,f,g,h,i,j,c="",k=0;for(b=a._utf8_encode(b);k<b.length;)d=b.charCodeAt(k++),e=b.charCodeAt(k++),f=b.charCodeAt(k++),g=d>>2,h=(3&d)<<4|e>>4,i=(15&e)<<2|f>>6,j=63&f,isNaN(e)?i=j=64:isNaN(f)&&(j=64),c=c+this._keyStr.charAt(g)+this._keyStr.charAt(h)+this._keyStr.charAt(i)+this._keyStr.charAt(j);
...
128>d?b+=String.fromCharCode(d):d>127&&2048>d?(b+=String.fromCharCode(d>>6|192),b+=String.fromCharCode(63&d|128)):(b+=String.fromCharCode(d>>12|224),b+=String.fromCharCode(d>>6&63|128),b+=String.fromCharCode(63&d|128))}return b},_utf8_decode:function(a){for(var b="",c=0,d=c1=c2=0;c<a.length;)d=a.charCodeAt(c),128>d?(b+=String.fromCharCode(d),c++):d>191&&224>d?(c2=a.charCodeAt(c+1),b+=String.fromCharCode((31&d)<<6|63&c2),c+=2):(c2=a.charCodeAt(c+1),c3=a.charCodeAt(c+2),b+=String.fromCharCode((15&d)<<12|(63&c2)<<6|63&c3),c+=3);
return b}},b=function(a){return unescape(encodeURIComponent(a))},c=function(a){return decodeURIComponent(escape(a))},d=function(a,b){if("function"==typeof window.atob)return b?c(window.atob(a)):window.atob(a);var e,f,g,h,i,j,k,l,d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",m=0,n=0,o="",p=[];if(!a)return a;a+="";do h=d.indexOf(a.charAt(m++)),i=d.indexOf(a.charAt(m++)),j=d.indexOf(a.charAt(m++)),k=d.indexOf(a.charAt(m++)),l=h<<18|i<<12|j<<6|k,e=l>>16&255,f=l>>8&255,g=255&l,p[n++]=64==j?String.fromCharCode(e):64==k?String.fromCharCode(e,f):String.fromCharCode(e,f,g);
while(m<a.length);return o=p.join(""),b?c(o):o},e=function(c,d){if(d&&b(c),"function"==typeof window.btoa)try{return window.btoa(c)}catch(e){}return a.encode(c)};return{utf8_encode:b,utf8_decode:c,atob:d,btoa:e}}),f("moxie/runtime/Runtime",["moxie/core/utils/Basic","moxie/core/utils/Dom","moxie/core/EventTarget"],function(a,b,c){function f(c,d,g,h,i){var k,j=this,l=a.guid(d+"_"),m=i||"browser";c=c||{},e[l]=this,g=a.extend({access_binary:!1,access_image_binary:!1,display_media:!1,do_cors:!1,drag_and_drop:!1,filter_by_extension:!0,resize_image:!1,report_upload_progress:!1,return_response_headers:!1,return_response_type:!1,return_status_code:!0,send_custom_headers:!1,select_file:!1,select_folder:!1,select_multiple:!0,send_binary_string:!1,send_browser_cookies:!0,send_multipart:!0,slice_blob:!1,stream_upload:!1,summon_file_dialog:!1,upload_filesize:!0,use_http_method:!0},g),c.preferred_caps&&(m=f.getMode(h,c.preferred_caps,m)),k=function(){var b={};
=======
