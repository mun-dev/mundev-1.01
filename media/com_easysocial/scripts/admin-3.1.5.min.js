...
}),m.getHash()&&m.Adapter.onDomLoad(function(){m.Adapter.trigger(a,"hashchange")})))},m.init()}(window);var b=[];a.fn.route=function(c){if(this.is("a")){var d=this.attr("custom-title"),e=this.attr("title");if(d)var e=d;else if(e){var f=a.joomla.appendTitle;"before"===f&&(e=a.joomla.sitename+(e?" - "+e:"")),"after"===f&&(e=(e?e+" - ":"")+a.joomla.sitename)}else e=a(document).find("title").text();var g=(new Date).getTime();b[g]=g,History.pushState(a.extend({timestamp:g,refresh:!0},c),e,this.attr("href"))}return this
},History.Adapter.bind(window,"statechange",function(){var a=History.getState();a.id===History.savedStates[0].id&&(window.location=a.url),a.data.timestamp in b?delete b[a.data.timestamp]:a.data.refresh&&(window.location=a.url)})};d(),b.resolveWith(d)};FD40.module("history",a)}(),function(){var a=function(a){var b=this,c=function(){a.fn.image=function(b){var b=a.Image[b];return b&&b.apply(this[0],a.makeArray(arguments).slice(1))},a.Image={get:function(b){var c="IMG"===this.nodeName,d=a(c?this:new Image),e=a.Deferred();
return d.load(function(){var a,b,f,g;c||d.appendTo("body");var h={width:a=d.width(),height:b=d.height(),aspectRatio:f=a/b,orientation:g=1===f?"square":1>f?"tall":"wide"};d.css({position:"absolute",left:"-99999px"}).data(h).addClass("orientation-"+g).removeAttr("style"),c||d.detach(),e.resolve(d,h)}).error(function(){e.reject()}).attr("src",b),e},aspectRatio:function(b,c){return a.isPlainObject(b)&&(b=b.width,c=b.height),b/c},orientation:function(b,c){return a.isPlainObject(b)&&(b=b.width,c=b.height),b===c?"square":b>c?"wide":"tall"
},resizeProportionate:function(a,b,c,d,e){var f=a,g=b,h=c/a;f=a*h,g=b*h;var i=g>d;return"outer"==e&&(i=d>g),i&&(h=d/b,f=a*h,g=b*h),{top:(d-g)/2,left:(c-f)/2,width:f,height:g}},resizeWithin:function(b,c,d,e){return a.Image.resizeProportionate(b,c,d,e,"inner")},resizeToFill:function(b,c,d,e){return a.Image.resizeProportionate(b,c,d,e,"outer")}}};c(),b.resolveWith(c)};FD40.module("image",a)}(),function(){var a=function(a){var b=this,d=function(){!function(a,c){"function"==typeof define&&define.amd?define(["leaflet"],c):"object"==typeof modules&&b.exports?b.exports=c(require("leaflet")):c(L)
...
},init:function(d,g){function j(b){var f,g,i,h=[],j={};for(g=0;g<b.length;g++)if(f=b[g],!(j[f.name]&&c.ua.safari&&c.ua.windows)){j[f.name]=!0,i=c.guid(),e[i]=f;var k=new c.File(i,f.fileName||f.name,f.fileSize||f.size);f.type.length<1?"FileReader"in a&&(reader=new FileReader,reader.readAsDataURL(f),reader.onload=function(){data=reader.result,data=data.substring(data.indexOf("base64,")+7),data=atob(data);var a=data.substring(0,3);"ID3"==a&&(k.name=f.name+".mp3"),h.push(k)}):h.push(k)}h.length&&d.trigger("FilesAdded",h)
}var h,i;return h=this.getFeatures(),h.html5?(d.bind("Init",function(a){var e,f,h,i,l,m,o,g=[],k=a.settings.filters,n=b.body;e=b.createElement("div"),e.id=a.id+"_html5_container",c.extend(e.style,{position:"absolute",background:d.settings.shim_bgcolor||"transparent",width:"100px",height:"100px",overflow:"hidden",zIndex:99999,opacity:d.settings.shim_bgcolor?"":0}),e.className="plupload html5",d.settings.container&&(n=b.getElementById(d.settings.container),"static"===c.getStyle(n,"position")&&(n.style.position="relative")),n.appendChild(e);
...
},trigger:function(a,b){this.tooltip.trigger(a,b),this.button.trigger(a,b)},show:function(){var c=this;if(c.enabled=!0,!c.wait){if(clearTimeout(c.hideTimer),c.exclusive&&a("[data-popbox-tooltip]").each(function(){var c=b.get(a(this));c&&c.hide(!0)}),c.button.addClass("active"),"click"==c.toggle){var d=a(document),e=b.toggleEvent+".popbox."+c.uid;d.off(e).on(e,function(b){var f=a(b.target).parents().andSelf();window.es.mobile&&f.filter(c.tooltip).length>0||(window.es.mobile||!(f.filter(c.button).length>0||f.filter(c.tooltip).length>0))&&(d.off(e),c.hide())
...
a.isString(e)&&(f=e,e=!0),a.isBoolean(e)&&b.field().toggleClass("has-error",e),void 0!==f&&b.showError(f)},"{field} clear":function(){b.field().removeClass("has-error"),b.field().removeClass("is-loading"),b.content().popoverES("destroy")},"{self} show":function(){b.field().trigger("onShow")},"{field} loading":function(a,c,d){b.field().addClass("is-loading"),b.notice().html(d)},"{field} loaded":function(){b.field().removeClass("is-loading")}}}),b.resolve()}),EasySocial.module("shared/fields/conditional",function(a){var b=this,c=a.isController("EasySocial.Controller.Field.Conditional");
c||(EasySocial.Controller("Field.Conditional",{defaultOptions:{id:null,fieldTargeted:[],operator:[],conditionValue:[],result:[]}},function(b,c,d){return{init:function(){c.id=d.data("id");var a=d.data("isconditional");a&&b.bindTargetedFields()},bindTargetedFields:function(){var e=d.data("conditions");e&&a.each(e,function(a,d){c.fieldTargeted.push(d.fieldId),c.operator.push(d.operator),c.conditionValue.push(d.value),b.formatConditionsValue(a),b.bindFields(a)})},bindFields:function(a){var c=b.getTargetedField(a);
b.isAutocomplete(a)?b.bindAutocompleteFields(a):(c.on("change",function(){b.fieldChanged(a)}),c.on("keyup",function(){b.fieldChanged(a)}),c.on("onFieldShow",function(){b.fieldChanged(a)}),c.hasClass("t-hidden")||b.fieldChanged(a)),c.on("onFieldHide",function(){b.hideSelf(a)})},bindAutocompleteFields:function(c){var d=b.getTargetedField(c),e=d.find("[data-field-suggest]"),f=[],g=d.data("name"),h=d.find(':input[name="'+g+'[]"]');h.length>0&&a.each(h,function(b,c){var d=a(c).val();f.push(d)}),e.on("addItem",function(a,d){f.push(d.value),b.fieldChanged(c,f)
}),e.on("removeItem",function(d,e){f.splice(a.inArray(e.value,f),1),b.fieldChanged(c,f)}),d.hasClass("t-hidden")||b.fieldChanged(c,f),d.on("onFieldShow",function(){b.fieldChanged(c,f)})},getRequiredChecking:function(){var b=a("[data-conditional-check]").val();return b?JSON.parse(b):!1},fieldChanged:function(e,f){if(!f)var f=b.getTargetedFieldValue(e);c.result[e]=b.checkCondition(f,e);var g=d.data("conditionsLogic");if(c.result){var h=!0;a.each(c.result,function(a,b){return"or"==g&&1==b?(h=!0,!1):(0==b&&(h=!1),void 0)
}),h?b.showSelf():b.hideSelf()}},checkCondition:function(d,e){var f=c.conditionValue[e],g=!1;switch(d=b.formatValue(d,e),c.operator[e]){case"equal":b.isAutocomplete(e)?a.each(d,function(a,b){return b==f?(g=!0,!0):void 0}):d==f&&(g=!0);break;case"not equal":b.isAutocomplete(e)?d.length>0&&(g=!0,a.each(d,function(a,b){return b==f?(g=!1,!0):void 0})):d!=f&&(g=!0);break;case"contain":b.isAutocomplete(e)?a.each(d,function(a,b){g=new RegExp("\\b"+f+"\\b","i").test(b)}):g=new RegExp("\\b"+f+"\\b","i").test(d)}return g
},getTargetedFieldValue:function(c){var d=b.getTargetedField(c),f=(b.getTargetedFieldElement(c),d.find(":input")),g=[],h=!1;return f.length>0&&a.each(f,function(){var b=a(this),c=b.attr("type");if("hidden"!=c)switch(c){case"radio":radio=b.is(":checked")?1:0,radio&&(g=b.val());break;case"checkbox":checkbox=b.is(":checked"),checkbox&&g.push(b.val());break;case"button":var d=b.parent(),e=d.find("input");"hidden"==e.attr("type")&&(g=e.val());break;default:b.val()&&(g=b.val())}}),a.isArray(g)?a.each(g,function(a,b){h=h?h+" "+b:b
}):h=g,h},showSelf:function(){d.removeClass("t-hidden"),d.trigger("onFieldShow"),b.updateRequiredChecking(!0)},hideSelf:function(){d.addClass("t-hidden"),d.trigger("onFieldHide"),b.updateRequiredChecking(!1)},updateRequiredChecking:function(d){var e=b.getRequiredChecking();e&&(e[c.id]=d,e=JSON.stringify(e),a("[data-conditional-check]").val(e))},isAutocomplete:function(a){return"autocomplete"==b.getTargetedFieldElement(a)?!0:!1},getTargetedField:function(b){var d=a('[data-field-item][data-id="'+c.fieldTargeted[b]+'"]');
...
},mandatoryCheck:function(){return b.fieldsTypeTab().filter('[id="core"]').hasClass(c.hiddenClass)},hasEmptySteps:function(){var c=b.step(),d=!1;return a.each(c,function(c,e){var e=a(e),f=e.data("id");return f?b.isStepEmpty(f)?(d=!0,!1):void 0:void 0}),d},isStepEmpty:function(c){var d=a(b.content.selector+'[data-id="'+c+'"]'),e=d.find(b.field.selector);return e.length>0?!1:!0},validate:function(){return b.mandatoryCheck()?b.hasEmptySteps()?(b.showDialogError("empty-step"),!1):!0:(b.showDialogError("mandatory"),!1)
},save:function(){var c=a.Deferred();if(!b.validate())return c.reject(),c;var d=b.fetchWorkflowData();return b.injectSaveData(d),c.resolve(),c},getAvailableFields:function(){return b.fetchWorkflowData(!0,!0)},fetchWorkflowData:function(d,e){var f=[],g=0,h=b.step();d&&(h=b.getCurrentStep()),a.each(h,function(d,h){var h=a(h),i=a(b.content.selector+'[data-id="'+h.data("id")+'"]'),j=[],k=[],l=i.find(b.field.selector);if(l.length>0){var m=0;if(a.each(l,function(b,d){var d=a(d);if(e)var f={fieldTitle:d.find("[data-field-item-title]").html(),fieldId:d.data("id"),fieldElement:d.data("element"),appId:d.data("appid")};
else var f={fieldTitle:d.find("[data-field-item-title]").html(),fieldId:d.data("id"),fieldElement:d.data("element"),appId:d.data("appid"),ordering:m,isNew:d.data("isnew"),params:c.fieldsValue[d.data("id")]};k.push(f),m++}),e)var j={stepId:h.data("id"),fields:k};else var j={stepId:h.data("id"),ordering:g,isNew:h.data("isnew"),params:c.stepsValue[h.data("id")],fields:k};f.push(j),g++}else h.data("id")&&(void 0===b.deletedSteps&&(b.deletedSteps=[]),b.deletedSteps.push(h.data("id")))});var i={steps:b.deletedSteps,field:b.deletedFields},j={steps:f,deleted:i};
return j},openWorkflowConfig:function(){var c=a(b.getTemplate("workflow-config"));c.find("[data-workflow-config-title]").val(b.titleInput().val()),c.find("[data-workflow-config-description]").val(b.descInput().val()),b.fieldSettings().html(c.wrap("<p/>").parent().html()),c.unwrap()},"{workflowConfigSave} click":function(c){var e=c.parents("[data-config-dialog]"),f=e.find("[data-workflow-config-title]").val(),g=e.find("[data-workflow-config-description]").val();b.titleInput().val(f),b.descInput().val(g),a("[data-structure-heading]").html(f),a("[data-structure-description]").html(g),b.closeDialog()
},"{newStep} click":function(){b.addStep()},"{step} click":function(a){var d=a.data("id");b.switchTab(d)},showFieldBrowser:function(){b.fieldBrowser().removeClass(c.hiddenClass),b.fieldBrowser().find("[data-message-group]").html("")},closeDialog:function(){b.fieldBrowser().addClass(c.hiddenClass),b.dialogError().addClass(c.hiddenClass),b.dialogFieldCancel().trigger("click")},showDialogError:function(d){var e=a(b.getTemplate("dialog-error")),f=e.find('[data-error-type="'+d+'"]');f.length>0?f.removeClass(c.hiddenClass):e.find('[data-error-type="default"]').removeClass(c.hiddenClass),b.fieldSettings().html(e.wrap("<p/>").parent().html()),e.unwrap()
},getNewFieldButton:function(){var b=a("[data-field-new]").first().clone();return b},getField:function(c){var d=a(b.field.selector+'[data-id="'+c+'"]');return d},updateFieldBrowser:function(a,d){var f=b.fieldBrowserItem().filter('[data-id="'+a+'"]'),g=f.parents(b.fieldTypeContent.selector);if("standard"!=g.attr("id")){f[d+"Class"](c.hiddenClass);var h=g.find(b.fieldBrowserItems.selector).children(),i=b.fieldsTypeTab().filter('[id="'+g.attr("id")+'"]');h.not("."+c.hiddenClass).length<1?(i.addClass(c.hiddenClass),b.fieldsTypeTab().not("."+c.hiddenClass).eq(0).trigger("click")):i.removeClass(c.hiddenClass)
}},switchTab:function(a){var d=b.getStepTab(a),e=b.getStepContent(a);b.step().removeClass("is-active"),d.addClass("is-active"),b.content().addClass(c.hiddenClass),e.removeClass(c.hiddenClass)},addStep:function(){var d=a.uid(),e=b.getTemplate("step");e.attr("data-id",d),e.insertBefore(b.newStep());var f=b.getTemplate("editor");f.attr("data-id",d),f.insertBefore(b.templates()),b.updateOrdering(b.step()),b.deleteStepButton().removeClass(c.hiddenClass),e.trigger("click")},addField:function(c,d,e){var f=!1;if(void 0==d){var d=b.getTemplate("field"),g=c.data("fieldElement");
"header"==g&&d.addClass("es-wf-field--header"),d.attr("data-id",a.uid()),d.attr("data-appid",c.data("id")),d.attr("data-element",g),d.find("[data-field-item-title]").html(c.data("fieldTitle")),d.find("[data-field-item-element]").html(g.toUpperCase()),f=!0}if(void 0==e)var e=b.getCurrentStep();var h=e.find("[data-fields-wrapper]"),i=h.find("[data-fields]");if(i.children().length>0){var j=i.find(b.currentNewField),k=j.data("action");j[k](d)}else b.currentNewField=b.getNewFieldButton().attr("data-action","after"),i.append(b.currentNewField),i.append(d),i.append(b.getNewFieldButton().attr("data-action","before"));
h.removeClass("is-empty"),b.updateOrdering(i.children()),b.initFieldsSortable(),f&&(b.setMessage(!1,"info",b.fieldBrowser()),b.updateFieldBrowser(c.data("id"),"add")),a.scrollTo(d.offset().top-250,200),d.addClass("is-new"),setTimeout(function(){d.removeClass("is-new")},1500)},"{fieldBrowserItem} click":function(a){b.addField(a)},"{fieldBrowser} click":function(a,c){c.target==a[0]&&(c.preventDefault(),c.stopPropagation(),b.closeDialog())},"{dialogError} click":function(a,c){c.target==a[0]&&(c.preventDefault(),c.stopPropagation(),b.closeDialog())
},"{dialogErrorClose} click":function(a,c){c.preventDefault(),c.stopPropagation(),b.closeDialog()},"{newField} click":function(a){b.currentNewField=a,b.showFieldBrowser()},"{fieldBrowserClose} click":function(a,c){c.preventDefault(),c.stopPropagation(),b.closeDialog()},"{fieldsTypeTab} click":function(d){b.fieldsTypeTab().removeClass("active"),d.addClass("active");var f=d.attr("id"),g=b.fieldTypeContent();g.addClass(c.hiddenClass),g.each(function(){a(this).attr("id")==f&&a(this).removeClass(c.hiddenClass)})},"{editStep} click":function(c){b.fieldSettings().html(b.getTemplate("dialog-loader"));
var e=c.parents(b.content.selector).data("id");b.fieldsData=[],EasySocial.ajax("admin/views/fields/loadStepConfiguration",{id:e}).done(function(c,d,f){b.stepsHtml&&a.each(b.stepsHtml,function(a,b){return b.stepId==e?(c=b.html,!1):void 0}),b.fieldSettings().html(c),b.fieldSettings().find("[data-fields-config-param-choices]").addController("EasySocial.Controller.Config.Choices"),a(b.fieldParam.selector).on("change",function(){b.paramChanged(a(this),f)}),a(b.fieldParam.selector).on("keyup",function(){b.paramChanged(a(this),f)
})})},"{dialogFieldCancel} click":function(a,c){c.preventDefault(),c.stopPropagation(),b.fieldSettings().html("")},storeFields:function(a,c,d){b.storeFieldsData(a,d)},storeSteps:function(a,c){b.storeStepsData(a,c)},deleteFields:function(a){c.fieldsValue[a]&&b.storeFieldsData(a)},deleteStep:function(d){var e=a(b.step.selector+"[data-id="+d+"]");if(e.prev().length>0)var f=e.prev();else var f=e.next();var g=b.getStepContent(d);a.each(g.find(b.field.selector),function(c,d){b.updateFieldBrowser(a(d).data("appid"),"remove")
}),void 0===b.deletedSteps&&(b.deletedSteps=[]),e.data("isnew")===!1&&b.deletedSteps.push(d),g.remove(),e.remove(),b.steps().children(b.step.selector).length<2&&b.deleteStepButton().addClass(c.hiddenClass),delete c.stepsValue[d],f.trigger("click"),b.isChanged()},storeFieldsData:function(a,b){c.fieldsValue[a]=b},storeStepsData:function(a,b){c.stepsValue[a]=b},getCurrentStep:function(){return b.content().not("."+c.hiddenClass)},getStepTab:function(c){return a(b.step.selector+'[data-id="'+c+'"]')},getStepContent:function(b){return a("[data-content][data-id="+b+"]")
},injectSaveData:function(a){b.saveFieldsInput().val(""),a&&(a=JSON.stringify(a),b.saveFieldsInput().val(a))},updateFieldTitle:function(a,c){if(c){var d=b.getField(a);d.find("[data-field-item-title]").html(c)}},updateFieldRequired:function(a,d){var e=b.getField(a),f=e.find(b.fieldRequiredSymbol.selector);e.attr("data-required",d),"1"==d?f.removeClass(c.hiddenClass):f.addClass(c.hiddenClass)},updateConditionsUI:function(d,e){var f=a(b.field.selector+'[data-id="'+d+'"]');return e&&void 0!=e?(f.find("[data-field-item-conditional]").removeClass(c.hiddenClass),f.addClass("has-condition"),void 0):(f.find("[data-field-item-conditional]").addClass(c.hiddenClass),f.removeClass("has-condition"),void 0)
},updateStepHeader:function(c,d,e){if(d||e){var f=a(b.step.selector+'[data-id="'+c+'"]'),g=a(b.content.selector+'[data-id="'+c+'"]');d&&(f.find("[data-step-title]").html(d),g.find("[data-step-title]").html(d)),e&&g.find("[data-step-description]").html(e)}},"{dialogStepSave} click":function(c){var e=c.parents("[data-field-dialog]"),f=e.data("id"),g=[],h=!1,i=!1;b.fieldsData&&a.each(b.fieldsData,function(a,b){var c={name:b.name,value:b.value};"title"==b.name&&(h=b.value),"description"==b.name&&(i=b.value),g.push(c)
});var j={stepId:f,html:e.wrap("<p/>").parent().html()},k=b.stepsHtml;b.stepsHtml=[],k&&a.each(k,function(a,c){c.stepId!=f&&b.stepsHtml.push({stepId:c.stepId,html:c.html})}),b.storeSteps(f,g),b.stepsHtml.push(j),b.updateStepHeader(f,h,i),b.closeDialog(),b.isChanged()},"{dialogFieldSave} click":function(d){var f=d.parents("[data-field-dialog]"),g=f.data("id"),i=(f.data("appid"),b.getCurrentStep().data("id")),j=f.find("[data-field-is-conditional]").is(":checked"),l=[],m=!1,n=[],o=b.getField(g).data("required");
b.fieldsData&&a.each(b.fieldsData,function(a,b){var c={name:b.name,value:b.value};"title"==b.name&&(b.value?m=b.value:c=!1),"required"==b.name&&(o=b.value),c&&(l.push(c),n[b.name]=!0)});({fieldId:g,html:f.wrap("<p/>").parent().html()});if(b.fieldsChoices){var q=[];a.each(b.fieldsChoices,function(a,b){var c={value:b.value};q.push({items:c})}),l.push({choices:q}),n.choices=!0}if(j||(b.fieldsConditions=[],l.push({conditions:!1})),b.fieldsConditions){a.each(b.fieldsConditions,function(a,b){var c={value:b.value};
l.push({conditions:c}),n.conditions=!0})}c.fieldsValue[g]&&a.each(c.fieldsValue[g],function(a,b){void 0===b.name||n[b.name]||l.push({name:b.name,value:b.value}),b.choices&&!n.choices&&l.push({choices:b.choices}),b.conditions&&!n.conditions&&l.push({conditions:b.conditions})}),b.storeFields(g,i,l),b.updateFieldTitle(g,m),b.updateFieldRequired(g,o),b.updateConditionsUI(g,j),b.closeDialog(),b.isChanged()},"{dialogFieldTab} click":function(a){var e=a.data("id");b.dialogFieldTab().removeClass("active"),a.addClass("active"),b.dialogFieldContent().addClass(c.hiddenClass),b.dialogFieldContent().filter('[data-id="'+e+'"]').removeClass(c.hiddenClass)
},"{deleteStepButton} click":function(a){var d=a.parents(b.content.selector),e=d.data("id");if(b.isStepEmpty(e))return b.deleteStep(e),!0;var f=b.getTemplate("dialog-delete-step");b.fieldSettings().html(f.wrap("<p/>").parent().html()),f.unwrap();var g=b.fieldSettings().find("[data-dialog-confirm]");g.on("click",function(){b.deleteStep(e),b.closeDialog()})},"{editField} click":function(d){var f=d.parents(b.field.selector),g=f.data("appid"),h=f.data("id"),i=c.fieldsValue[h],j=b.getAvailableFields(),k=[];b.fieldsData=[],b.fieldsConditions=[],b.fieldsChoices=[],b.fieldSettings().html(b.getTemplate("dialog-loader")),EasySocial.ajax("admin/views/fields/loadFieldConfiguration",{appId:g,fieldId:h,previousData:i,availableFields:j}).done(function(c,d,e){a.each(e,function(b,c){a.each(c.fields,function(b,c){c.subfields?a.each(c.subfields,function(a,c){k[b+"_"+a]=c
