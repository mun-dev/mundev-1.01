...
<div class="es-apps-item es-island">
	<div class="es-apps-item__hd">
		...
		<?php if ($user->isViewer() && ($userAcl->get('add_entry') || $userAcl->get('delete_entry'))) { ?>
		<div class="es-apps-item__action">
			<div class="o-btn-group">
				...
				<ul class="dropdown-menu dropdown-menu-right">
					...
					<?php if ($userAcl->get('delete_entry')) { ?>
					<li>
	...
	<div class="es-apps-item__bd">
		<div class="es-apps-item__desc">
			<?php if ($post->image) { ?>
				<a href="<?php echo EBR::_('index.php?option=com_easyblog&view=entry&id=' . $post->id);?>" class="blog-image t-lg-pull-right t-lg-ml--xl t-lg-mb--xl">
					<img src="<?php echo $post->image;?>" align="right" width="220" />
				</a>
			<?php } ?>
