		...
		<div class="es-mobile-filter__hd-cell is-slider">
			<div class="es-mobile-filter-slider is-end-left" data-es-sly-slider-group>
				<div class="es-mobile-filter-slider__content" >
					...
					<div class="es-mobile-filter-slider__item <?php echo $active == 'going' ? 'is-active' : '';?>"
						data-es-sly-item
					...
					<?php if ($event->getParams()->get('allowmaybe', true)) { ?>
						<div class="es-mobile-filter-slider__item <?php echo $active == 'maybe' ? 'is-active' : '';?>"
							data-es-sly-item
					...
					<?php if ($event->getParams()->get('allownotgoingguest', true)) { ?>
						<div class="es-mobile-filter-slider__item <?php echo $active == 'notgoing' ? 'is-active' : '';?>"
							data-es-sly-item
					...
					<div class="es-mobile-filter-slider__item <?php echo $active == 'admin' ? 'is-active' : '';?>"
						data-es-sly-item
					...
					<?php if ($event->isClosed() && ($event->isAdmin() || $event->isOwner())) { ?>
						<div class="es-mobile-filter-slider__item <?php echo $active == 'pending' ? 'is-active' : '';?>"
							data-es-sly-item
