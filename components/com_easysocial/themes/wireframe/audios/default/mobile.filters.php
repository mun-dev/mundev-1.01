...
<div class="es-mobile-filter" data-es-mobile-filters>
	...
	<div class="es-mobile-filter__bd" data-es-audio-filters>
		<div class="es-mobile-filter__group <?php echo $activePlaylist || $activeGenre ? 't-hidden' : 'is-active';?>" data-es-sly-group data-type="filters">
		...
		<div class="es-mobile-filter__group <?php echo $filter == 'customFilter' && $activeCustomFilter ? 'is-active' : 't-hidden';?>" data-es-sly-group data-type="hashtags">
			<div class="es-mobile-filter-slider is-end-left" data-es-sly-slider>
				<div class="es-mobile-filter-slider__content">
		...
		<?php if ($browseView) { ?>
		<div class="es-mobile-filter__group" data-es-sly-group data-type="genres">
		...
		<div class="es-mobile-filter__group <?php echo $activePlaylist ? 'is-active' : 't-hidden';?>" data-es-sly-group data-type="playlist">
			<div class="es-mobile-filter-slider is-end-left" data-es-sly-slider>
				<div class="es-mobile-filter-slider__content" >
					<?php if ($lists) { ?>
