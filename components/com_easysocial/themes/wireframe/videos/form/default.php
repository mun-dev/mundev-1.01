...
=======
							...
							<div class="o-form-group <?php echo $video->isUpload() ? 't-hidden' : '';?>" data-form-link data-form-source>
								...
								<div class="o-control-input">
									<?php echo $this->html('grid.inputbox', 'link', $video->isLink() ? $video->path : '', 'video-link-source', array('placeholder="' . JText::_('COM_EASYSOCIAL_VIDEOS_VIDEO_LINK_PLACEHOLDER') . '"'));?>
								</div>
							</div>
							<?php } ?>
