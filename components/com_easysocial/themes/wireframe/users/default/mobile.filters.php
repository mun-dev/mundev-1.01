...
<div class="es-mobile-filter" data-es-mobile-filters>
	...
	<div class="es-mobile-filter__bd" data-es-group-filters>
		<div class="es-mobile-filter__group <?php echo $filter != 'profiletype' ? 'is-active' : 't-hidden';?>" data-es-sly-group data-type="filters">
		...
		<div class="es-mobile-filter__group <?php echo $filter == 'profiletype' ? 'is-active' : 't-hidden';?>" data-es-sly-group data-type="profiles">
			<div class="es-mobile-filter-slider is-end-left" data-es-sly-slider>
				<div class="es-mobile-filter-slider__content">
