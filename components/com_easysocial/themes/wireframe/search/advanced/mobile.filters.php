...
<div class="es-mobile-filter" data-es-mobile-filters>
	...
	<div class="es-mobile-filter__bd">
		<div class="es-mobile-filter__group <?php echo $activeFilter ? 't-hidden' : 'is-active';?>" data-es-sly-group data-type="discover">
		...
		<div class="es-mobile-filter__group <?php echo !$activeFilter ? 't-hidden' : 'is-active';?>" data-es-sly-group data-type="filters">
			<div class="es-mobile-filter-slider is-end-left" data-es-sly-slider>
				<div class="es-mobile-filter-slider__content">
