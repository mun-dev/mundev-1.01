...
<div class="es-mobile-filter">
	<div class="es-mobile-filter__hd">
		...
		<div class="es-mobile-filter__hd-cell is-slider">
			<div class="es-mobile-filter-slider is-end-left" data-es-polls-filter data-es-slider>
				<div class="es-mobile-filter-slider__content" >
					<div class="es-mobile-filter-slider__item <?php echo $filter == 'all' ? 'is-active' : '';?>"
						data-es-sly-item
					...
					<?php if ($this->my->id) { ?>
					<div class="es-mobile-filter-slider__item <?php echo $filter == 'mine' ? 'is-active' : '';?>"
						data-es-sly-item
