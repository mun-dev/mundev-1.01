...
=======
							...
							<div class="t-lg-pull-right">
								<?php if ($event->hasRecurringEvents() || $event->isRecurringEvent()) { ?>
									...
									<button type="button" class="btn btn-es-primary" data-edit-save><?php echo JText::_('COM_EASYSOCIAL_EVENTS_EDIT_RECURRING_EVENT_APPLY_THIS_BUTTON'); ?></button>
								<?php } else { ?>
									<button type="button" class="btn btn-es-primary" data-task="update" data-edit-save>
