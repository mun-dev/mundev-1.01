...
<div class="es-mobile-filter" data-es-mobile-filters>
	...
	<div class="es-mobile-filter__bd" data-es-events-filters>
		...
		<div class="es-mobile-filter__group is-active" data-es-sly-group data-type="about">
			<div class="es-mobile-filter-slider is-end-left" data-es-sly-slider>
				<div class="es-mobile-filter-slider__content">
					<?php $i = 0; ?>
					<?php foreach ($steps as $step) { ?>
						<?php echo $this->html('mobile.filterTab', $step->get('title'), 'javascript:void(0)', $i == 0 ? true : false, array('data-group-edit-fields-step', 'data-for="' . $step->id . '"', 'data-actions="1"')); ?>
						<?php $i++; ?>
					<?php } ?>

					<?php if ($group->isDraft()) { ?>
						<?php echo $this->html('mobile.filterTab', JText::_('COM_ES_APPROVAL_HISTORY'), 'javascript:void(0)', false, array('data-group-edit-fields-step', 'data-for="history"', 'data-actions="1"')); ?>
					<?php } ?>
