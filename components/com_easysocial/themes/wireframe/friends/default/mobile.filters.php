...
<div class="es-mobile-filter" data-es-mobile-filters>
	...
	<div class="es-mobile-filter__bd" data-es-group-filters>
		<div class="es-mobile-filter__group <?php echo !$activeList ? 'is-active' : 't-hidden';?>" data-es-sly-group data-type="filters">
		...
		<div class="es-mobile-filter__group <?php echo $activeList ? 'is-active' : 't-hidden';?>" data-es-sly-group data-type="lists">
			<div class="es-mobile-filter-slider is-end-left" data-es-sly-slider>
				<div class="es-mobile-filter-slider__content">
					<?php if ($lists) { ?>
