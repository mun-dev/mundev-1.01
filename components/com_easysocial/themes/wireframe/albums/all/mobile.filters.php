		...
		<div class="es-mobile-filter__hd-cell is-slider">
			<div class="es-mobile-filter-slider is-end-left" data-es-sly-slider-group>
				<div class="es-mobile-filter-slider__content">
					...
					<div class="es-mobile-filter-slider__item<?php echo $filter == 'all' ? ' is-active' : '';?>" data-es-sly-item>
					...
					<?php if ($this->my->id) { ?>
					<div class="es-mobile-filter-slider__item" data-es-sly-item>
					...
					<div class="es-mobile-filter-slider__item<?php echo $filter == 'favourite' ? ' is-active' : '';?>" data-es-sly-item>
