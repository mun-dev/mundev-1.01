	...
	<div class="es-mobile-filter__bd" data-es-events-filters>
		...
		<?php foreach ($groups as $group) { ?>
			<?php if (isset($alerts[$group]) && $alerts[$group] ) { ?>
				...
				<div class="es-mobile-filter__group<?php echo $i == 0 ? ' is-active': ' t-hidden'; ?>" data-es-sly-group data-type="<?php echo $group; ?>">
		...
		<?php if ($customAlerts) { ?>
			<div class="es-mobile-filter__group t-hidden" data-es-sly-group data-type="custom">
				<div class="es-mobile-filter-slider is-end-left" data-es-sly-slider>
					<div class="es-mobile-filter-slider__content">
		...
		<div class="es-mobile-filter__group t-hidden" data-es-sly-group data-type="links">
