...
<div class="o-avatar-status<?php echo ($user->isOnline()) ? ' is-online': ' is-offline'; ?>">
	...
	<a href="<?php echo $user->getPermalink();?>"
		class="o-avatar o-avatar--<?php echo $size; ?> o-avatar--text o-avatar--bg-<?php echo $user->getNameInitial()->code;?> <?php echo ($this->config->get('layout_avatar')) ? 'o-avatar--text' : '' ?>"
	...
	>
		...
		<?php } else { ?>
			<?php echo $user->getNameInitial()->text;?>
		<?php } ?>
	</a>
</div>
