...
?>
<<<<<<< HEAD
<div id="eb" class="eb-mod mod-easyblogshowcase--thumb st-3 mod-easyblogshowcase<?php echo $modules->getWrapperClass(); ?>  <?php echo $modules->isMobile() ? 'is-mobile' : '';?>">
	<div class="eb-gallery-stage" data-eb-module-showcase data-autoplay="<?php echo $autoplay;?>" data-interval="<?php echo $autoplayInterval;?>">
...
=======
<div id="eb" class="eb-mod st-3 mod-easyblogshowcase<?php echo $modules->getWrapperClass(); ?>  <?php echo $modules->isMobile() ? 'is-mobile' : '';?>" data-eb-module-showcase>
				...
				<div class="mod-table">
					<div class="col-cell">
						<div class="eb-gallery-menu">
							<?php $i = 0; ?>
							<?php foreach ($posts as $post) { ?>
								<div class="eb-gallery-menu-item <?php echo $i == 0 ? 'active' : '';?>" style="background-image: url('<?php echo $post->postCover;?>');"></div>
								<?php $i++;?>
							<?php } ?>
						</div>
					</div>
