		...
		>
				...
				<div class="m-list--inline m-list--has-divider t-lg-mb-sm">
					<?php if ($params->get('showcategory', 1)) { ?>
						<div class="m-list__item">
							<?php echo JText::sprintf('MOD_EASYDISCUSS_MOST_HIT_POSTED_IN_CATEGORY', $post->getCategory()->getPermalink(), $post->getCategory()->getTitle()); ?>
						</div>
					<?php } ?>
